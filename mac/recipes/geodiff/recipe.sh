...
VERSION_geodiff=0.8.2

# dependencies of this recipe
DEPS_geodiff=()

# url of the package
URL_geodiff=https://github.com/lutraconsulting/geodiff/archive/release-${VERSION_geodiff}.tar.gz

# md5 of the package
MD5_geodiff=b7955ce070a26ec21851db46c8a4d33f
